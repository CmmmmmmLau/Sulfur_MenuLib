...
namespace MenuLib.MonoBehavior {
    public class ColourPickerController : MonoBehaviour {
        ...
        private void Awake() {
            RSlider.onValueChanged.AddListener(arg0 => {
                RInputField.text = ((int)arg0).ToString();
            });
            GSlider.onValueChanged.AddListener(arg0 => {
                GInputField.text = ((int)arg0).ToString();
            });
            BSlider.onValueChanged.AddListener(arg0 => {
                BInputField.text = ((int)arg0).ToString();
            });
            ASlider.onValueChanged.AddListener(arg0 => {
                AInputField.text = ((int)arg0).ToString();
            });
            
            RInputField.onEndEdit.AddListener((arg0 => RSlider.value = int.TryParse(arg0, out int r) ? Mathf.Clamp(r, 0, 255) : RSlider.value));
            GInputField.onEndEdit.AddListener((arg0 => GSlider.value = int.TryParse(arg0, out int g) ? Mathf.Clamp(g, 0, 255) : GSlider.value));
            BInputField.onEndEdit.AddListener((arg0 => BSlider.value = int.TryParse(arg0, out int b) ? Mathf.Clamp(b, 0, 255) : BSlider.value));
            AInputField.onEndEdit.AddListener((arg0 => ASlider.value = int.TryParse(arg0, out int a) ? Mathf.Clamp(a, 0, 255) : ASlider.value));
                        
            RInputField.onValueChanged.AddListener((arg0 => {
                UpdateColor();
            }));
            GInputField.onValueChanged.AddListener((arg0 => {
                UpdateColor();
            }));
            BInputField.onValueChanged.AddListener((arg0 => {
                UpdateColor();
            }));
            AInputField.onValueChanged.AddListener((arg0 => {
                UpdateColor();
            }));
